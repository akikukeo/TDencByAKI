...
set UP_SITE_START1=YouTube？それともニコニコ？それともTwitter？（y/n/N/t）
set UP_SITE_START2=（YouTubeならy、ニコニコならn(一部の新基準対象者はN)、Twitterならtを選びなさいよね）
...
set PREMIUM_ERROR1=ニコニコのサーバ仕様変更で今までのエンコはできなくなったわよ！
set PREMIUM_ERROR2=サイト選択のところで大文字のNを選択しなさいよね！
...
set RETURN_MESSAGE12=目標解像度がTwitterの制限より高いわよ！
set RETURN_MESSAGE13=上限以下にリサイズをしなさいよね！
